...
Lemma repr_distr_add: forall a b, 
    repr (a+b) = add (repr a) (repr b).       
Proof.  
  intros.
  rewrite add_unsigned.
  eapply eqm_samerepr.
  eapply eqm_add; apply eqm_unsigned_repr.
Qed.
...
Lemma repr_distr_sub : forall a b,
    repr(a-b) = sub (repr a) (repr b). 
Proof.
  intros.
  rewrite sub_add_opp.
  rewrite neg_repr.
